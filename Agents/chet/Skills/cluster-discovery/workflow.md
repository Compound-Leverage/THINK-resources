...
`Templates/cluster-discovery-chet.md` for the base format, or `schema.md` in this
folder for the full field list and status transitions. No 0-100 fit score and no separate fit
