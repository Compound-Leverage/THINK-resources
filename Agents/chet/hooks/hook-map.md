...
(Claude scheduled routine or ChatGPT Scheduled Task), see `Workflows/capture-team-open.md`,
...
|---|---|---|
| Weekly, once | Scheduled routine (see `Workflows/capture-team-open.md`'s Chet row) | `Skills/cluster-discovery/` -- discover new groups for unmapped capabilities, refresh existing known groups (membership, budget confirmation, window estimate), archive anything whose window has closed without conversion |
...
`Workflows/capture-team-open.md` for the full explanation and the durability note about
