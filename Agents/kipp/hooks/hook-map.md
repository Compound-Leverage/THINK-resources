...
`Workflows/kipp-crm-intake.md`, which already documents Kipp's cadence as part of
...
|---|---|---|
| Daily, once | Scheduled routine (see `Workflows/kipp-crm-intake.md`) | `Skills/crm-intake/` -- sweep every configured intake source (signal inbox, scored prospect list, warm inbound), enrich, classify, write to CRM |
...
See `Workflows/kipp-crm-intake.md` for the full explanation and the durability note
