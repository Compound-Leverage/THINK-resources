# Alex - BD Research (sales-bd-team-open) -- Automation Setup
...
Name each routine after the persona (e.g. `alex-bd-research`) so `/schedule list` stays
...
`Plugins/sales-bd-team-open/skills/alex-bd-research/SKILL.md` and your
