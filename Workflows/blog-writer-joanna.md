# Joanna (content-team) -- Automation Setup
...
Name the routine after the persona (e.g. `blog-writer-joanna`) so `/schedule list`
...
`Plugins/content-team/skills/blog-writer-joanna/SKILL.md` and your
