# Chet (capture-team) -- Automation Setup
...
Name the routine `cluster-discovery-chet` so `/schedule list` stays readable once you're
...
thin: "Read `Plugins/capture-team/skills/cluster-discovery-chet/SKILL.md` and
