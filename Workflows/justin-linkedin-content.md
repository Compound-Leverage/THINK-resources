# Justin (content-team-open) -- Automation Setup
...
Name the routine after the persona (e.g. `justin-linkedin-content`) so `/schedule list`
...
`Plugins/content-team-open/skills/justin-linkedin-content/SKILL.md` and your
