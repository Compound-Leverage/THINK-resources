# Ann (content-team) -- Automation Setup
...
Name the routine after the persona (e.g. `newsletter-editor-ann`) so `/schedule list`
...
`Plugins/content-team/skills/newsletter-editor-ann/SKILL.md` and your
