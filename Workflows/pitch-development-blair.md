...
[`Workflows/proposal-engine-lead-maya.md`](./proposal-engine-lead-maya.md) for how the
two tracks relate.
...
Name the routine `pitch-development-blair` so `/schedule list` stays readable once you're
...
`Plugins/proposal-team/skills/pitch-development-blair/SKILL.md` and your
