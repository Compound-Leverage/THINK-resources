...
Name the routine after the persona (e.g. `proof-points-marcus`) so `/schedule list` stays
...
itself thin: "Read `Plugins/sales-enablement/skills/proof-points-marcus/SKILL.md`
