# Priya (proposal-team) -- Automation Setup
...
Name the routine `proposal-analyst-priya` so `/schedule list` stays readable once you're
...
`Plugins/proposal-team/skills/proposal-analyst-priya/SKILL.md` and your
