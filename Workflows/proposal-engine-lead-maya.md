...
Name the routine `proposal-engine-lead-maya` so `/schedule list` stays readable once
...
`Plugins/proposal-team/skills/proposal-engine-lead-maya/SKILL.md` and your
...
[`Workflows/pitch-development-blair.md`](./pitch-development-blair.md) for that track.
