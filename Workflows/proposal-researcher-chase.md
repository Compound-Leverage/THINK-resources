# Chase (proposal-team) -- Automation Setup
...
Name the routine `proposal-researcher-chase` so `/schedule list` stays readable once
...
`Plugins/proposal-team/skills/proposal-researcher-chase/SKILL.md` and your
