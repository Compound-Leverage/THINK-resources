# Quinn (proposal-team) -- Automation Setup
...
Name the routine `proposal-writer-quinn` so `/schedule list` stays readable once you're
...
`Plugins/proposal-team/skills/proposal-writer-quinn/SKILL.md` and your
