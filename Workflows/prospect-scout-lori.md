...
`Plugins/sales-bd-team/skills/prospect-scout-lori/SKILL.md` and your
...
1. Open a conversation with Lori's `SKILL.md` uploaded (see
...
Claude Code routine with MCP access can - Lori's output will need a manual copy/paste
