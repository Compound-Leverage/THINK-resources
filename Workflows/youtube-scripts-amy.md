# Amy (content-team) -- Automation Setup
...
Name the routine after the persona (e.g. `youtube-scripts-amy`) so `/schedule list`
...
`Plugins/content-team/skills/youtube-scripts-amy/SKILL.md` and your
...
[`Workflows/master-intel-scan-rohit.md`](master-intel-scan-rohit.md) for the full weekly
sequence.
