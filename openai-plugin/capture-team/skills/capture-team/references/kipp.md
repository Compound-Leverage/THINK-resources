...
- `qualification_profiles` -- your qualification profiles, one per pursuit
  type: `business_development`, `govcon`, or `grant_funding`. Each profile
  defines its own criteria set -- business-development ICP (industry,
